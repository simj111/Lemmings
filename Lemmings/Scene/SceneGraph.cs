...
{
    class SceneGraph
    //The SceneGraph is used to manage the entities in the Scene, with the SceneManager telling it what to do.
    //It updates the scene with adding and removing entities when they are needed.
    {
        ...
        #region Constructor
        //The SceneGraph initialises the private entityList as a dictionary, and the private drawingList as a list of objects.
        public SceneGraph() 
        {
